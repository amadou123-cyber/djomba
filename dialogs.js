import { ActivityIndicator,  StyleSheet, FlatList, Image, Text, View, RefreshControl } from 'react-native';
import React, { useState, useEffect, useLayoutEffect } from 'react';
import { Avatar, Badge,Divider, Button,ListItem } from '@rneui/themed';
          ...
          renderItem={({ item }) => (
            ...
            <ListItem.Content>
              <ListItem.Title style={{
                  ...
                  }}>{item.user.nom} { item.user.online ? <Ionicons name="ellipse" size={12} color="orange" /> : null}  </ListItem.Title>
